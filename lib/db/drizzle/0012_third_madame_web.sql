...
ALTER TABLE "adaptive_recommendations" ADD CONSTRAINT "adaptive_recommendations_session_id_sessions_id_fk" FOREIGN KEY ("session_id") REFERENCES "public"."sessions"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "adaptive_recommendations" ADD CONSTRAINT "adaptive_recommendations_source_attempt_id_attempts_id_fk" FOREIGN KEY ("source_attempt_id") REFERENCES "public"."attempts"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "adaptive_recommendations" ADD CONSTRAINT "adaptive_recommendations_source_question_id_questions_id_fk" FOREIGN KEY ("source_question_id") REFERENCES "public"."questions"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "adaptive_recommendations" ADD CONSTRAINT "adaptive_recommendations_student_user_id_users_id_fk" FOREIGN KEY ("student_user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "adaptive_recommendations" ADD CONSTRAINT "adaptive_recommendations_recommended_question_id_questions_id_fk" FOREIGN KEY ("recommended_question_id") REFERENCES "public"."questions"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
CREATE UNIQUE INDEX "adaptive_recommendation_source_unique_idx" ON "adaptive_recommendations" USING btree ("session_id","source_attempt_id","source_question_id");--> statement-breakpoint
DO $$ BEGIN
