      ...
      <main className="flex-1">
        <section className="relative overflow-hidden border-b pt-16 pb-20 md:pt-24 md:pb-28">
          ...
          <div className="container relative z-10 mx-auto grid gap-12 px-6 lg:grid-cols-[1.1fr_.9fr] lg:items-end">
            <div className="max-w-3xl">
              <p className="mb-6 inline-flex rounded-full bg-accent/10 px-3 py-1 text-sm font-semibold text-accent">
                For students and families planning what comes next
              </p>
              <h1 className="text-5xl font-bold leading-[1.05] tracking-tight md:text-7xl">
                A clear next step for your <span className="text-gradient-brand">college goals.</span>
              </h1>
              ...
              <div className="mt-10 flex flex-col gap-3 sm:flex-row">
                <Button asChild size="lg" className="h-14 w-full rounded-full bg-gradient-brand px-7 text-base text-white shadow-lg shadow-primary/20 transition-all hover:-translate-y-0.5 hover:shadow-xl sm:w-auto">
                  <Link href="/sat" data-testid="link-home-sat">
                    Explore the SAT session <ArrowRight className="ml-2 h-5 w-5" />
                  </Link>
                </Button>
                <Button asChild size="lg" variant="outline" className="h-14 w-full rounded-full px-7 text-base sm:w-auto">
            ...
            <div className="rounded-3xl border bg-card/85 p-6 shadow-xl shadow-primary/5 backdrop-blur-sm md:p-8">
              <p className="text-sm font-semibold uppercase tracking-[0.18em] text-accent">Start with the right path</p>
              <div className="mt-6 space-y-5">
                <div className="flex gap-4">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-primary/10 text-primary"><GraduationCap className="h-5 w-5" /></div>
                  <div>
                ...
                <div className="flex gap-4">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-accent/10 text-accent"><MessageCircle className="h-5 w-5" /></div>
                  <div>
        ...
        <section className="border-b bg-card py-20">
          <div className="container mx-auto px-6">
            <div className="max-w-2xl">
              <p className="text-sm font-semibold uppercase tracking-[0.2em] text-accent">Two ways to begin</p>
              <h2 className="mt-3 text-3xl font-bold tracking-tight md:text-4xl">Choose what matches your question today.</h2>
        ...
        <section className="container mx-auto px-6 py-20">
          <div className="grid gap-12 lg:grid-cols-[.8fr_1.2fr] lg:items-start">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-bold tracking-tight md:text-4xl">A straightforward beginning.</h2>
        ...
        <section className="border-y bg-card">
          <div className="container mx-auto grid gap-8 px-6 py-16 md:grid-cols-2">
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.2em] text-accent">Explore with confidence</p>
              <h2 className="mt-3 text-3xl font-bold tracking-tight">See the people and published stories behind the work.</h2>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <Link href="/our-team" data-testid="link-home-team" className="rounded-2xl border bg-background p-5 transition-colors hover:border-primary/40">
              ...
              <Link href="/past-success" data-testid="link-home-stories" className="rounded-2xl border bg-background p-5 transition-colors hover:border-primary/40">
