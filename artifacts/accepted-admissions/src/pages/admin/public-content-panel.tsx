          ...
          <CardHeader>
            <div className="flex min-w-0 flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
              <div className="min-w-0">
                ...
                <CardDescription className="break-words">Public /sat marketing copy. SAT prices and checkout stay in the signed-in client portal book/pay flow.</CardDescription>
              </div>
              <div className="flex shrink-0 flex-wrap items-center gap-2">
