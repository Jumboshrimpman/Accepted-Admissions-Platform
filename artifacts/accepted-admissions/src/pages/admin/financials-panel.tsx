      ...
      <CardContent className="space-y-7">
        <section className="space-y-3 rounded-2xl border p-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Public checkout sells Single SAT Session ($130 / 1 credit) and Ten SAT Session Package ($1,300 / 10 credits). Funds settle to Accepted Admissions; credits grant only after a verified Stripe webhook.</p>
          </div>
